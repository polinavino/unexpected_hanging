...
\author{Polina Vinogradova}% <-this % stops a space
...
%Specifically, a test is a surprise for a student if and only if the student
%cannot deduce logically beforehand the date of the test. This interpretation was first proposed by Shaw
...
the two necessary possibilities that must exist for other week days.
