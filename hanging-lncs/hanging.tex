...
\begin{abstract}
  ...
  works equally well in both constructive and classical logics.
  Unlike what is presented in existing work, we are able to give a classical
  definition, without self-reference,
  in a way that lets us make the same intuitive conclusions formally.
